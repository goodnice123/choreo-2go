...
const UUID = process.env.UUID || '4a96e460-ea37-4e15-9a84-16c1a8fa6fe2'; //若需要改UUID，需要在config.json里改为一致
...
const NEZHA_KEY = process.env.NEZHA_KEY || 'hJiXVw2G5EMnCGT2DT';   // 没用哪吒，把这个参数空着
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'choreo.future13800.eu.org';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiNjc0MmMxNDI5ZDE4OTA3NjMzZjMyZjQ2MWM5MzUwOWMiLCJ0IjoiYThmMDNlOWYtNmNkYy00MDM0LWE4NmUtY2QzZDZjODc1YjIyIiwicyI6Ik5qbGtZVGd5WmpVdFpEYzFaaTAwWkdOaUxXRm1PVFV0TmpKa00yUmlNR05tWmpCbSJ9';
